import { A2_CAPABILITY_ID, A6_CAPABILITY_ID, canonicalizeA2Envelope, runA2Skill, runA6Skill } from './skill-runtime/index.js';
...
export function createCapabilityAdapter({
  ...
  return async function invoke(capabilityId, context = {}) {
    return withRetry(async () => {
      if (capabilityId === A2_CAPABILITY_ID) return canonicalizeA2Envelope(await runA2(context));
